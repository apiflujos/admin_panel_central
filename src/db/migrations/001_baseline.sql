...
CREATE TABLE IF NOT EXISTS alegra_accounts (
  id SERIAL PRIMARY KEY,
  organization_id INTEGER NOT NULL REFERENCES organizations(id),
...
CREATE TABLE IF NOT EXISTS products (
  ...
  organization_id INTEGER NOT NULL REFERENCES organizations(id),
  shop_domain TEXT NOT NULL DEFAULT '',
  source TEXT NOT NULL DEFAULT 'alegra',
  alegra_item_id TEXT,
...
CREATE TABLE IF NOT EXISTS invoice_settings (
  ...
  apply_payment BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS invoice_documents (
  ...
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  UNIQUE (organization_id, alegra_invoice_id)
);
...
CREATE TABLE IF NOT EXISTS shopify_store_configs (
  id SERIAL PRIMARY KEY,
  organization_id INTEGER NOT NULL REFERENCES organizations(id),
  shop_domain TEXT NOT NULL,
  transfer_destination_warehouse_id TEXT,
  transfer_origin_warehouse_ids TEXT,
  transfer_priority_warehouse_id TEXT,
  transfer_strategy TEXT NOT NULL DEFAULT 'consolidation',
  price_list_general_id TEXT,
  price_list_discount_id TEXT,
  price_list_wholesale_id TEXT,
  currency TEXT,
  alegra_account_id INTEGER,
  config_json JSONB,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS inventory_transfer_decisions (
  id SERIAL PRIMARY KEY,
  organization_id INTEGER NOT NULL REFERENCES organizations(id),
  shop_domain TEXT,
  order_id TEXT,
  chosen_warehouse_id TEXT,
  rule TEXT,

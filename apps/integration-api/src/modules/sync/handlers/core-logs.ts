...
import { listSyncLogs, retryFailedLogs } from "../../../../../../src/services/logs.service";
...
export async function listLogs(req: Request, res: Response) {
  ...
  try {
    ...
    res.status(500).json({ items: [], filters: { status, orderId, entity, direction, from, to }, error: message });
  }
}

...
const CRON_TASKS: CronTask[] = [
  ...
  {
    name: "Marketing · sync de pedidos",
    kind: "cron",
    schedule: "Diario · 02:00",
    envVar: "MARKETING_CRON_SYNC",
    enabledByDefault: true,
    detail: "Encola la sincronización de pedidos por dominio Shopify para métricas de marketing.",
  },
  {
    name: "Marketing · gasto de Ads",
    kind: "cron",
    schedule: "Diario · 02:15",
    envVar: "MARKETING_CRON_ADS",
    enabledByDefault: true,
    detail: "Sincroniza el gasto de Google Ads, Meta Ads y TikTok Ads.",
  },
  {
    name: "Marketing · recálculo de métricas",
    kind: "cron",
    schedule: "Diario · 02:30",
    envVar: "MARKETING_CRON_METRICS",
    enabledByDefault: true,
    detail: "Recalcula las métricas diarias (ventana de 30 días) por dominio.",
  },
  {
    name: "Marketing · evaluación de alertas",
    kind: "cron",
    schedule: "Diario · 03:00",
    envVar: "MARKETING_CRON_ALERTS",
    enabledByDefault: true,
    detail: "Evalúa las alertas de marketing por dominio.",
  },
  {

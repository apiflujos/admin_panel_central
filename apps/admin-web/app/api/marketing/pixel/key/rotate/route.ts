...
import { rotatePixelKey } from "../../../../../../../../src/marketing/db/marketing.repository";
...
export const POST = routeHandler(async (req: Request) => {
  ...
  try {
    ...
    return NextResponse.json({ error: error instanceof Error ? error.message : "pixel_rotate_error" }, { status: 400 });
  }
});

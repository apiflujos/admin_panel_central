...
export const GET = routeHandler(async (req: Request) => {
  ...
  const range = isMetricsRange(searchParams.get("range")) ? (searchParams.get("range") as MetricsRange) : "month";
  ...
  } else if (type === "top_products_revenue") {
  ...
  } else if (type === "top_products_units") {
